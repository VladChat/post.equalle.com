# ============================================
# File: blog-equalle/main_instagram.py
# Purpose: Pick next RSS post and publish to Instagram Business
# ============================================
...
def main() -> None:
    print("[ig][main] === Instagram auto-post ===")
    ...
    if not image_url:
        print("[ig][main][WARN] No Instagram card found, aborting.")
        return
